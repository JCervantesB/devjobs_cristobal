<div>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extrabold text-4xl text-gray-700 mb-12">Nuestras vacantes disponilbes</h3>
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                    ...
                    <div wire:key='{{$vacante->id}}' class="md:flex md:justify-between md:items-center py-5" >
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">
                                Ultimo día para enviar CV:
                                <span class="font-normal">{{$vacante->ultimo_dia->format('d/m/Y')}}</span>
                            </p>

                        </div> 
                        <div class="mt-5 md:mt-0">
                            <a class="bg-teal-600 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center" href="{{route ('vacantes.show', $vacante->id)}}">
                                Ver vacante
                            </a>
                        </div>
                    </div>
                ...
                @empty
                    <p class="p-3 text-center text-sm">No hay vacantes aún
                @endforelse
            </div>
